...
#include "LPC17xx.h"				/* Include device specific declareation file here */

#define	INIT_PORT()	init_port()	/* Initialize MMC control port (CS=H, CLK=L, DI=H, DO=in) */
#define DLY_US(n)	delayRIT1us(n)	/* Delay n microseconds */
...
{
	SSPReceiveBuffer (SD_SPI, buff, bc);
}
